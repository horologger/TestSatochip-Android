...
- **Satochip**: A hardware wallet with BIP32 support for importing BIP39 seeds, signing transactions, and signing Nostr events
...
```gradle
dependencies {
    implementation files('libs/satochip-lib-0.2.6.jar')
